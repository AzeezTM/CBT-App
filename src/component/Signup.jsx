  ...
  return (
    <div className="demo-wrap">
      ...
      <form  className="form mt-5" onSubmit={handleSubmit}>
        <h2 className="text-align-center mb-4">Sign Up </h2>
        ...
        <button type="submit" className="btn1 btn btn-primary mb-3">Sign Up</button>

        <p className="showlogin" onClick={handleClick}>Already registered {""} Log In ?</p>
