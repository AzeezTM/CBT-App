...
const Home = () => {
  ...
  //   },
  //   {
  //     ques: "what is the Name of the mammal that the male carries prgnancy and give birth?",
  //     options: [
            ...
            <div className="question-section">
              ...
              <div className="answer-section mb-5">
                ...
                {questions[currentQues].options.map((option) => (
                   ...
                   <div className="btn1 btn btn-outline-success" key={option.id} onClick={() => addAnswer(option.isCorrect)}>{option.answertext}</div>
                  // <div >
                  //   <input type="radio"
                  //     key={index}
